...
FINAL_BUDGET_S = 120.0


class Q3ParticleController(V163Controller):
    """v165 speed-risk branch: bounded final validation + single-bearing triangulation + exploration cost caps."""
