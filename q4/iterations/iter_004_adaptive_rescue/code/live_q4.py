...
TARGETED_RESCUE_TRAVEL_PENALTY = 0.00035
TARGETED_BREAK_ON_EMPTY = True
TARGETED_REQUIRED_MIN_POSITIVE = 10
TARGETED_LOW_COUNT_TRAVEL_PENALTY = 0.00035
TARGETED_AFTER_FIND_TRAVEL_PENALTY = 0.00035
    ...
    try:
        ...
        if TARGETED_POST_CLEAR_RESCUE and _targeted_trigger:
            ...
            for _target_index in range(_target_budget):
                ...
                # 补查最多两次；第二次先利用新的无信号约束重新规划，避免固定四次空走。
