...
VERSION='v452-triangle-prefix-tail2'
...
BOOTSTRAP_POINTS=4
LOW_COUNT_TAIL_BUDGET=2
LOW_COUNT_TAIL_MAX_FOUND=12
...
def run_q4(client, *, case_code, real_margin_s=45.0, scan_detected_again=True, fast=False, full_census=False):
    ...
    clear_detected()
    tails=[]
    tail_budget=(LOW_COUNT_TAIL_BUDGET if len(found)<=LOW_COUNT_TAIL_MAX_FOUND else TAIL_BUDGET)
